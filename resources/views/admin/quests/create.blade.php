...
@section('title', 'Создание квеста')
@section('page-title', 'Создание квеста')
@section('page-subtitle', 'Добавление нового квеста в систему')
...
<div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="short_description" 
                                      ...
                                      rows="2"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Краткое описание для карточек и списков">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      required
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Подробное описание квеста, условия выполнения, советы...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="difficulty" 
                                ...
                                @foreach($difficulties as $value => $label)
                                    <option value="{{ $value }}" {{ old('difficulty') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                                    ...
                                    @foreach($chunk as $route)
                                        <div class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                            <input type="checkbox" 
                                                   ...
                                                   name="routes[]" 
                                                   value="{{ $route->id }}"
                                                   {{ in_array($route->id, old('routes', [])) ? 'checked' : '' }}
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       name="is_repeatable" 
                                       value="1"
                                       {{ old('is_repeatable', false) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
    ...
    "Отметить все чекпоинты"
                ...
                <div class="sticky top-6 space-y-3">
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-3 rounded-lg font-bold text-lg transition duration-300">
                        <i class="fas fa-save mr-2"></i> Создать квест
                    </button>
                    
                    <a href="{{ route('admin.quests.index') }}" 
                       class="block w-full bg-gray-200 hover:bg-gray-300 text-gray-800 py-3 rounded-lg font-bold text-lg text-center transition duration-300">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Устанавливаем конечную дату как через месяц
